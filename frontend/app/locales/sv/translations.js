export default {
  ...
  "patron": {
    ...
    'accept_text_help_block': "Jag har tagit del av <a target='_blank' href='https://www.ub.gu.se/regler'>Regler för användning av Göteborgs universitetsbibliotek</a> och förbinder mig att följa dem.",
    'pul_link': "<a href='https://www.ub.gu.se/personuppgifter' target='_blank'>Om hantering av personuppgifter (pdf)</a>",
