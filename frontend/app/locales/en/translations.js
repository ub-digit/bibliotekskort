export default {
  ...
  "patron": {
    ...
    'accept_text_help_block': "I confirm that I am familiar with the  <a target='_blank' href='https://www.ub.gu.se/rules'>Rules for the use of Gothenburg University Library</a> and undertake to follow these rules.",
    'pul_link': "<a href='https://www.ub.gu.se/personal-data' target='_blank'>About the processing of personal data (pdf)</a>",
