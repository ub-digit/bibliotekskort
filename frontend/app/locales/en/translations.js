export default {
  ...
  "patron": {
    ...
    'accept_text_help_block': "I confirm that I am familiar with the  <a target='_blank' href='https://www.ub.gu.se/en/rules-for-the-use-of-gothenburg-university-library'>Rules for the use of Gothenburg University Library</a> and undertake to follow these rules.",
  ...
  "confirm": {
    ...
    "extra_info": 'Pick up the library card at one of <a target="_blank" href="https://www.ub.gu.se/en/libraries-and-opening-hours">our libraries</a>. Please bring <a target="_blank" href="https://www.ub.gu.se/en/borrow-and-log-in/gu-card-and-library-card#library-card-for-everyone">approved physical ID documents</a>.',
