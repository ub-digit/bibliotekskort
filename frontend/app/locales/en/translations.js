export default {
  ...
  "patron": {
    ...
    'accept_text_help_block': "I confirm that I am familiar with the  <a target='_blank' href='http://www.ub.gu.se/%3C-sv,en%3E/lana/regler/'>Rules for the use of Gothenburg University Library</a> and undertake to follow these rules.",
    'pul_link': "<a href='http://www.ub.gu.se/(en)/lana/regler/pul.pdf' target='_blank'>About the processing of personal data (pdf)</a>",
